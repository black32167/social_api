...
public class JavaServerSdkGenerator extends DefaultCodegen implements CodegenConfig {
  ...
  public Map<String, Object> postProcessOperationsWithModels(Map<String, Object> objs, List<Object> allModels) {
    ...
    for(CodegenOperation co : opList){
     ...
     // co.operationId = co.httpMethod.toLowerCase() + co.baseName;
      // example:
  ...
  public String getHelp() {
    return "Generates a java-server-sdk client library.";
  }

  public JavaServerSdkGenerator() {
    super();

    // set the output folder here
    outputFolder = "generated-code/java-server-sdk";
